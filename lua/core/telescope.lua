return {
  ...
  keys = {
    ...
    { '<leader>tcs/', function() require('core.telescope-custom').find_files_slash() end, desc = '[Telescope] search /' },
    { '<leader>tcso', function() require('core.telescope-custom').find_files_root() end, desc = '[Telescope] search root' },
    { '<leader>tcsh', function() require('core.telescope-custom').find_files_home() end, desc = '[Telescope] search home' },
    { '<leader>tcse', function() require('core.telescope-custom').find_files_etc() end, desc = '[Telescope] search etc' },
    { '<leader>tcsv', function() require('core.telescope-custom').find_files_var() end, desc = '[Telescope] search var' },
    { '<leader>tcsl', function() require('core.telescope-custom').find_files_log() end, desc = '[Telescope] search log' },
    { '<leader>tcsm', function() require('core.telescope-custom').find_files_mps() end, desc = '[Telescope] search mps' },
    { '<leader>tcsr', function() require('core.telescope-custom').find_files_repo() end, desc = '[Telescope] search repo' },
    { '<leader>tcss', function() require('core.telescope-custom').find_files_scratch() end, desc = '[Telescope] search scratch' },
